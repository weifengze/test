package com.zicms.framework.shiro.web.filter.kickout;
...
public class KickoutSessionFilter extends AccessControlFilter {
    ...
    private boolean isAjaxResponse(ServletRequest request, ServletResponse response) throws IOException {
        ...
        if (ServletUtils.isAjaxRequest(req)) {
            JsonResult jsonResult = com.zicms.commons.base.JsonResult.error("您已在别处登录，请您修改密码或重新登录");
            ServletUtils.renderString(res, OBJECT_MAPPER.writeValueAsString(jsonResult));
        } else {
